window.addEventListener("load", function () {
  ...
  class Player {
    constructor(gameWidth, gameHeight) {
      ...
      this.frameY = 0;
      this.maxFrame = 7;
      this.fps = 20; // how fast we swap between horizontal animation frames
      this.frameTimer = 0;
      this.frameInterval = 1000 / this.fps; // how many ms each frame lasts
      this.speed = 0;
      this.vy = 0; // smth like coords for jumping
      this.weight = 1; // smth like gravity for jumping
    }
  ...
  function animate(timeStamp) {
    const deltaTime = timeStamp - lastTime; // the time my computer needs to serve 1 animation frame
    lastTime = timeStamp;
